...
class CriarItem():
  ...
  def botoes(self, home: Type[tk.Tk]):
    ...
    self.botaoCriar = Button(self.frame2, text="CRIAR ITEM")
    self.botaoCriar.place(relx="0.55", rely="0.35",relwidth="0.25", relheight="0.30")

    self.labelNome =  Label(self.frame1,text="Item")
    self.labelNome.place(relx="0.2", rely="0.30",relwidth="0.25", relheight="0.075")

    self.getNome = Entry(self.frame1)
    self.getNome.place(relx="0.2", rely="0.40",relwidth="0.25", relheight="0.075")
